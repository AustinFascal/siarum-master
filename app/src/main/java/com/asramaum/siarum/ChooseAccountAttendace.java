...
public class ChooseAccountAttendace extends SlidingActivity {
    ...
    public void init(Bundle savedInstanceState) {
        setContent(R.layout.activity_choose_account_attendance);
            ...
            if(getUserInfo.getAccountType().equals(true)){
                ...
                btnCard1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent i = new Intent(ChooseAccountAttendace.this, AttendanceActivity.class);
